...
class UsersStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetUserByID = channel.unary_unary(
                ...
                request_serializer=users__pb2.RetrieveUserByIDRequest.SerializeToString,
...
def add_UsersServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetUserByID': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=users__pb2.RetrieveUserByIDRequest.FromString,
...
class Users(object):
    ...
    def GetUserByID(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/users.Users/GetUserByID',
            users__pb2.RetrieveUserByIDRequest.SerializeToString,
